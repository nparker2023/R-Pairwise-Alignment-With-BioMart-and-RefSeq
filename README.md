# R pipeline tutorial to query and manipulate data from BioMart and RefSeq in order to retrieve and align protein sequences from two different species
...
<img src="output_file_photos/mart_output_R.png" width="352.5" height="106.5">
